...
There is a [SYNDERAI Synthetic Data Generation and Use Policy](index.php?menu=policy) defined.
...
- **Conversion of FHIR JSON to FHIR XML (3):** The compiled output is converted from FHIR JSON to FHIR XML serialization formats. This is a necessary step to complete the set of instances for simpler vizualisation using the [vi7eti methodology](https://vi7eti.net).
